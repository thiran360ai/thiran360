...
export default function data() {
  ...
  return {
    ...
    rows: [
      {
        companies: [logoXD, "Larsen & Toubro Limited"],
        members: (
      ...
      {
        companies: [logoAtlassian, "Hindustan Construction Company Limited"],
        members: (
          <SoftBox display="flex" py={1}>
            {avatars([
              [team2, "Romina Hadid"],
      ...
      {
        companies: [logoSlack, "Gammon India Limited."],
        members: (
          <SoftBox display="flex" py={1}>
            {avatars([
              [team1, "Ryan Tompson"],
      ...
      {
        companies: [logoSpotify, "Punj Lloyd Ltd"],
        members: (
          <SoftBox display="flex" py={1}>
            {avatars([
              [team4, "Jessica Doe"],
      ...
      {
        companies: [logoInvesion, "Jaypee Group"],
        members: (
          <SoftBox display="flex" py={1}>
            {avatars([
              [team1, "Ryan Tompson"],
