...
const projectsTableData = {
  ...
  rows: [
    {
      project: [logoWebDev, "Larsen & Toubro Limied"],
      budget: (
    ...
    {
      project: [logoWebDev, "Hindustan Construction Company Limited"],
      budget: (
        <SoftTypography variant="button" color="text" fontWeight="medium">
          $5,000
        </SoftTypography>
    ...
    {
      project: [logoWebDev, "Gammon India Limited."],
      budget: (
        <SoftTypography variant="button" color="text" fontWeight="medium">
          $3,400
        </SoftTypography>
    ...
    {
      project: [logoWebDev, "Punj Lloyd Lt"],
      budget: (
        <SoftTypography variant="button" color="text" fontWeight="medium">
          $1,400
        </SoftTypography>
    ...
    {
      project: [logoWebDev, "Jaypee Group"],
      budget: (
        <SoftTypography variant="button" color="text" fontWeight="medium">
          $2,300
        </SoftTypography>
