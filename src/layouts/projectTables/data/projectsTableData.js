...
const projectsTableData = {
  ...
  rows: [
    {
      project: [logoSpotify, "Larsen & Toubro Limied"],
      budget: (
    ...
    {
      project: [logoInvesion, "Hindustan Construction Company Limited"],
      budget: (
        <SoftTypography variant="button" color="text" fontWeight="medium">
          $5,000
        </SoftTypography>
    ...
    {
      project: [logoJira, "Gammon India Limited."],
      budget: (
        <SoftTypography variant="button" color="text" fontWeight="medium">
          $3,400
        </SoftTypography>
    ...
    {
      project: [logoSlack, "Punj Lloyd Lt"],
      budget: (
        <SoftTypography variant="button" color="text" fontWeight="medium">
          $1,400
        </SoftTypography>
